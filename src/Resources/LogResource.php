            ...
            ->columns([
                Tables\Columns\TextColumn::make('recipient')
                    ...
                    ->tooltip(fn (Tables\Columns\TextColumn $column): ?string =>
                        strlen($column->getState()) > $column->getLimit() ? $column->getState() : null
                    ),
                ...
                Tables\Columns\TagsColumn::make('attachments')
                    ->limit(2)
                    ->getStateUsing(fn (Log $record): array =>
                        $record
                            ->attachments
                            ->pluck('name')
                            ->all()
                ...
                Tables\Columns\TextColumn::make('template_frozen')
                    ...
                    ->url(fn (Log $record): ?string =>
                        is_null($record->template_id) ? null : URL::route('filament.resources.templates.edit', [
